...
export const DASHBOARD_CATEGORIES = [
  ...
  { number: "04", title: "Kuliner", href: "#kuliner", intro: "Pilihan makanan dan minuman JOE.", items: ["Mie Kriuk", "Nasgomer", "Mie Godhog Kuah Merah", "Es Kopi", "Es Kopi Susu", "Es Kopi Jahe Serai", "Joe Espresso", "Joe Kopi Susu 1 Liter", "Monin - Tofico Coffee"] },
...
export const CULINARY: CatalogItem[] = [
  { name: "Mie Kriuk", intro: "Menu kuliner JOE.", description: "" },
  { name: "Nasgomer", intro: "Menu kuliner JOE.", description: "" },
  { name: "Mie Godhog Kuah Merah", intro: "Menu kuliner JOE.", description: "" },
